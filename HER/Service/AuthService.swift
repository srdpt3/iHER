...
//            
//            guard let userId = authData?.user.uid else { return }
//            let user = User.init(id: userId, email: email, profileImageUrl: "", username: username, age: age, gender: gender, company: "", createdDate:  Date().timeIntervalSince1970, stats: UserStats(followers: 0, following: 0))
